...
> 作者：Henry_He  
> 原文：[主篇](https://linux.do/t/topic/2538870) · [补充篇](https://linux.do/t/topic/2588749)  
> 本文将两篇内容去重合并，图片均已本地化。
...
![gif](AI时代的思维框架-图片/0bd247de5495641ad5e20b88507053476a24d666.webp)
...
[`学 ai 上 Linuxdo`](https://linux.do/)![:distorted_face:](AI时代的思维框架-图片/asset-02.png)
...
![image](AI时代的思维框架-图片/33ec55c69466f27792df849083a4af082bf257a9.png)

### 注意力稀释

地形塑造初期，明确的指令可以造成明显的地形变化，然而当空间的小球数量增加后，地形的张力会被逐渐拉平和稀释，原本的深沟坡度也会逐渐平缓；无意义的小球（修饰词，标点）也会参与平摊坡度。

![image](AI时代的思维框架-图片/37da533741754428687668d2f0fb41938e5a2b12.png)

在长对话中模型会逐渐淡化提示词设定，因此需要反复强调核心指令，比如 `说中文`：

![image](AI时代的思维框架-图片/3cc72c4c0f86c260292ae5c8028d1cc82410b425.png)

### 语义惯性

当对话持续是某一个风格或主题时，已有小球会在地表某个区域形成更深的峡谷，即更深的历史上下文状态，此时如果下一轮对话切换到另一个场景，小球极易受到上文的地形影响

![image](AI时代的思维框架-图片/78e6d501464f527b2396fbb705b244f9c801e29e.png)
...
![image](AI时代的思维框架-图片/d13c3d8a4c56fabd31336a1ce0dd6e3a1d5b6f5d.png)

> 思维链（Chain of Thought, COT）通过在陡峭的山坡上修筑起 “阶梯平台。后续小球每次只需滚向高一点的平台完成接力，并最终翻越山脊

![image](AI时代的思维框架-图片/52fe45d4c43cd4ba4dd012f98ade60cc54c428cb.png)

### 相变

前面提到地形变化不是线性发生，可能在临界点引起整个地形的剧烈走向。比如一些看似毫无意义的废话最终在宏观表达上起到决定作用

![image](AI时代的思维框架-图片/b673ba0344581ae0bef05dfcc0c456f12ff78719.png)
...
![image](AI时代的思维框架-图片/5eb5eb903fc9db08bf3747038ca6c9c037003555.png)

原本只想点亮逻辑性，但不可避免地激活了枯燥、学术废话等区域

更明显的例子 三色韦恩图：

![image](AI时代的思维框架-图片/9b15b4379d803bfc268b348808c8b6b6449a7198.png)
...
![image](AI时代的思维框架-图片/d0551b9a5b34235ffdc90b139e26e3fc01f277ab.jpeg)

### 先推理后结论

单独拎出来是因为很多人喜欢让模型先得到结论，但后续的推理都是基于这个结论锚点做采样塑造地形轨道，或者说都是为了圆这个结论而做的辩护

![image](AI时代的思维框架-图片/36d4317f640042217f77f8c620a209adf99ac6da.png)

### 入戏与共振采样

特定设定引导模型进入某个场景后，多步推理产生的一连串 token 会表现出高度共振，滚雪球式的形成极深的峡谷，在对话轮数越少时效果越好，噪声越少塑造越牢固

![image](AI时代的思维框架-图片/40529340967e5adbfb2d549fdce46a9110b0c0b7.jpeg)
...
![image](AI时代的思维框架-图片/e98ee0f4518f100c5fdcfb4ce0fb385e6db082a7.jpeg)
...
![image](AI时代的思维框架-图片/11500e0a7299fc53eed8ea6488b488d8b1b9ee2a.png)

显式表达很方便，不需要花很多精力管理上下文和注意力，但也存在很多弊端

##### 知识冗余

![image](AI时代的思维框架-图片/fde7f9b527980d2c3581f548d4cda6b911255041.png)
...
![image](AI时代的思维框架-图片/67481d3ec8cbdb957e55d6fcc4161f642d078718.png)

##### 认知降维

运用显式的语义一方面会引导模型的注意力，另一方面也会将模型困于使用者的认知上限而失去了寻优能力

![image](AI时代的思维框架-图片/b7c241904d747d2eb896397d7e1aa8c038007eaf.png)
...
![image](AI时代的思维框架-图片/98711d0ce87b06a3ae552d789f07886b5f446369.png)
...
![image](AI时代的思维框架-图片/f985f2ee87bed44b22485c9d95f4e795cdb54c1e.png)
...
![image](AI时代的思维框架-图片/627faffb01d960cebd3f1ef561caf6551ad2073b.png)
...
![image](AI时代的思维框架-图片/000d31ad2cc4db451c59362bb5bdd3e8af1d04bc.png)

会计学追求实质重于形式，会讲求严格的资源权衡，我们可以预期会计学语义能强化对话中模型的资源分配逻辑

![image](AI时代的思维框架-图片/c46194826937c1b81027dba046f3171938b061b3.jpeg)
...
![image](AI时代的思维框架-图片/24dc3a14b98b3e6acfe14e8a40c72d436eadb3f9.png)

比如 `通俗易懂`，`奥卡姆剃刀`，`第一性原理`

![image](AI时代的思维框架-图片/f5e4de27487cbaa8b412427d5adcfed676687aff.png)
