...
# ManimGL's public API is intentionally exported through ``manimlib.*`` and its
# vector stubs reject list literals that the runtime accepts as NumPy vectors.
# pyright: reportWildcardImportFromLibrary=false, reportArgumentType=false, reportOperatorIssue=false
# ruff: noqa: F403, F405
