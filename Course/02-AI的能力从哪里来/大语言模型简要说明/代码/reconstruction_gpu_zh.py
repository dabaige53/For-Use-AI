...
class ParallelizabilityChinese(InteractiveScene):
    def construct(self):
        # Set up curves
        n_instances = 20
        ...
        # Setup words
        in_word = Text("输入", font="PingFang SC")
        out_word = Text("输出", font="PingFang SC")
        ...
        gpu_name = Text("GPU（图形处理器）", font="PingFang SC", font_size=30)
