...
- Original article: [3Blue1Brown](https://www.3blue1brown.com/lessons/mini-llm/)
- [Source code](https://github.com/3b1b/videos/blob/master/_2024/transformers/)
- [Video](https://www.youtube.com/watch?v=LPZh9BOjkQs)

![Video cover](素材/图片/mini-llm-cover.jpg)
...
![Image](素材/工程素材/images/script.jpg)
...
![Image](素材/工程素材/images/probability.jpg)
...
![Image](素材/工程素材/images/append.jpg)
...
![Image](素材/工程素材/images/parameter.jpg)
...
![Image](素材/工程素材/images/billions.jpg)
...
![Image](素材/工程素材/images/training.jpg)

An algorithm called backpropagation is then used to tweak all of the parameters in such a way that it makes the model a little *more* likely to choose the true last word and a little *less* likely to choose all the other words.

![Image](素材/工程素材/images/backpropogation.jpg)
...
![Image](素材/工程素材/images/pretraining.jpg)
...
![Image](素材/工程素材/images/google.jpg)
...
![Image](素材/工程素材/images/token.jpg)

Each one of these long lists of numbers must somehow encode the meaning of the corresponding word.

What makes transformers unique is their reliance on a special operation known as attention. This operation gives all of these lists of numbers a chance to communicate with one another and refine the meanings they encode based on the *context* around, all done in parallel.

![Image](素材/工程素材/images/bank.jpg)
...
![Image](素材/工程素材/images/overover.jpg)
...
- A more technical overview of LLMs

- More on attention

- More on feed-forward neural network(MLP)
